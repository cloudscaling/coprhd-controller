...
public class CephUtils {
    ...
    public static CephClient connectToCeph(CephClientFactory factory, StorageSystem storage) {
        return factory.getClient(storage.getSmisProviderIP(), storage.getSmisUserName(), storage.getKeyringKey());    	
    }

    public static CephClient connectToCeph(CephClientFactory factory, AccessProfile accessProfile) {
        return factory.getClient(accessProfile.getIpAddress(), accessProfile.getUserName(), accessProfile.getKeyringKey());    	
    }
